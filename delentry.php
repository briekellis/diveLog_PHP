...
if (!$_POST)  {
	...
	<a href=\"".$_SERVER['PHP_SELF']."\">delete another</a>?...Return to the <a href='addressBookMenu.html'>main menu</a>?</p>";
}
?>
<!DOCTYPE html>
<html>
